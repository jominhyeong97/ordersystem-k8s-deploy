...
//    Qualifier는 기본적으로 메서드를 통한 주입 가능, 이 경우 생성자 주입방식을 해야 Qualifier 사용가능
    @Autowired
...
//        rt 그자체 검증
        ...
        Member member = memberRepository.findByEmail(email).orElseThrow(() -> new EntityNotFoundException("엔티티낫파운드"));
//        redis의 값과 비교하는 검증
